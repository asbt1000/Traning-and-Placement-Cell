...
<?php
$sql = "INSERT INTO $dbname.students(sname,dept,email,contact,dob) VALUES ('$sname','$sdept','$semail','$scontact','$date')";

if ($conn->query($sql) === TRUE) {
echo "<h3 style=\"color:#3d5c5c;; text-align:center; font-family:cursive;\"> Student Added Successfully! Click to go to <a href=\"admin.php\">HOME.</a></h3>";
}
