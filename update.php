...
.dataTables_filter, .dataTables_info { display: none; }
  ...
  <p>Updated Successfully and Mail sent.</p>
  </div>
  <div class="header1">
...
<?php
$sql = "SELECT cname,name,designation,email,contact,reason,date from comp_sche order by date";
